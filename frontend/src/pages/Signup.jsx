...
import { getCurrentUser, signInWithOAuth, signUp, waitForSessionUser } from '../services/auth'
    ...
    <PageTransition>
      <section className='mx-auto flex w-full max-w-5xl justify-center px-6 py-16'>
        <div className='w-full max-w-md'>
          <Card title='Sign Up' description='Create your GreenLytics account.'>
            <form onSubmit={handleSubmit} className='mt-6 space-y-5'>
              ...
              <label className='block text-sm font-medium text-zinc-700 dark:text-zinc-200'>
                Password
                <input type='password' value={password} onChange={(e) => setPassword(e.target.value)} className={inputClass} placeholder='Create password' required />
              </label>
